(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.relativeDate = f() } })(function () {
  var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (_dereq_, module, exports) {
      ...
      exports.default = {
        just_now: 'agora a pouco',
        seconds_ago: '{{time}} segundos',
        a_minute_ago: 'um minuto',
        minutes_ago: '{{time}} minutos',
        an_hour_ago: 'uma hora',
        hours_ago: '{{time}} horas',
        a_day_ago: 'um dia',
        days_ago: '{{time}} dias',
        a_week_ago: 'uma semana',
        weeks_ago: '{{time}} semanas',
        a_month_ago: 'um mês',
        months_ago: '{{time}} meses',
        a_year_ago: 'um ano',
        years_ago: '{{time}} anos',
        over_a_year_ago: 'mais de um ano',
